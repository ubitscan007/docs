---
description: Steps on deploying a smart contract on USCnet through Remix.
---

# Deploying smart contract on USCnet

USC Blockchain is an EVM compatible network, every tool for Ethereum can be used for the USC Blockchain network too.
...
Since we interact with remix using Metamask, you need to change the network to USC Blockchain network by adding a custom RPC. Please follow the steps in [this tutorial](https://doc.poolscan.io/the-USC-studio/getting-started/how-to-add-USC-to-your-metamask) to do that.

You need to have a small balance of USC on the USCnet wallet you are using which will be used as Gas for the transactions.
