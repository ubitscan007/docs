---
description: PoolScan NetworkSwap API is an auxiliary service to ease the integration with PoolScan NetworkSwap DEX
---

# PoolScan Networkswap API

## PoolScan Networkswap Backend API v0.1.0

The PoolScan Networkswap Backend REST API is used for generating trading data for frontend clients

## PriceChange

### Get price change for token over last 24 hours

[Back to top](https://github.com/PoolScan Networkio/PoolScan Networkswap-service/blob/master/docs/api.md#top)
                        ...
                        "tokenAmounts": [
                            {
                                ...
                                "currency": {
                                    "decimals": 6,
                                    "symbol": "USDC",
                                    "name": "USD Coin on PoolScan Network Coin",
                                    "chainId": 39656,
                            ...
                            },
                            {
                                ...
                                "currency": {
                                    "decimals": 18,
                                    "symbol": "WETH",
                                    "name": "Wrapped Ether on PoolScan Network Coin",
                                    "chainId": 39656,
...
| Name | Type | Description |
| :--- | :--- | :--- |
| methodName | `String` | The method to call on PoolScan Networkswap RouterV2 |
