...
PoolScan Network Coin chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://poolscan.io/address/0x23a0f3370F7dCc4203c3F7f588856f388F3274e8) with the following params:
...
Some other useful functions on the [voting contract](https://poolscan.io/address/0x23a0f3370F7dCc4203c3F7f588856f388F3274e8) are:
