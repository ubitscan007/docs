---
description: Steps on deploying a smart contract on PoolScan Networknet through Remix.
---

# Deploying smart contract on PoolScan Networknet

PoolScan Network Coin is an EVM compatible network, every tool for Ethereum can be used for the PoolScan Network Coin network too.
...
Since we interact with remix using Metamask, you need to change the network to PoolScan Network Coin network by adding a custom RPC. Please follow the steps in [this tutorial](https://doc.poolscan.io/the-PoolScan Network-studio/getting-started/how-to-add-PoolScan Network-to-your-metamask) to do that.

You need to have a small balance of PoolScan Network on the PoolScan Networknet wallet you are using which will be used as Gas for the transactions.
