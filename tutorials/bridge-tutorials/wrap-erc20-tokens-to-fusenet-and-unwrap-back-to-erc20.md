---
description: >-
  Steps to transfer/wrap USC20 tokens from Ethereum to USCnet and back using
  smart contracts.
---

# Using the bridge with USC20 tokens directly through the contract

**Please use this tutorial at your own risk as it involves using Etherscan UI/USC Blockchain explorer to relay the tokens. This tutorial is applicable only for USC20 tokens other than USC. Do not use this tutorial to transfer USC.** 
...
USCnet Mediator : **0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03**

In the below example we will consider USDT \(USC20\) and learn how to wrap USDT to USCnet and relay it back to USC20.
...
Once the transaction is confirmed on-chain we wait for 2 blocks to ensure security of transaction and then the USDT tokens should appear on your USC Blockchain address and have been swapped from Ethereum mainnet to USCnet.

Now let’s learn how to transfer the wrapped USC20 tokens on USCnet back to Ethereum mainnet.

**Step 1:** Approving the wrapped USDT token contract on USCnet. 

This step basically is to approve your wallet to interact with the USDT token contract on USCnet so that you can transfer the tokens to the Mediator contract.

Please go to token contract on USCnet explorer via link below.

https://poolscan.io/address/0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10/write\_proxy

![](../../.gitbook/assets/4%20%286%29.png)

Make sure that the network is USC network. If you have not added USC Blockchain network please follow the instructions [here](https://doc.poolscan.io/the-USC-studio/getting-started/how-to-add-USC-to-your-metamask).

Click on **“Connect to Metamask”** and sign in to your wallet through Metamask.

 **Step 2:** Go to **“approve”** and enter the details below

* spender \(address\) field: the mediator contract address on USCnet \(0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03\)
...
Navigate to Migrator contract on USCnet using the link below
...
* token \(address\) field: the USDT token contract address on USCnet \(0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10\)
* \_value \(uint256\): the amount of tokens to transfer in wei \(Number of decimals should be 6\)

![](../../.gitbook/assets/6%20%285%29.png)

After the transaction is confirmed on USC Blockchain network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as USC Blockchain is PoS network. After sometime you should be able to see the successful transfer of the token on your USC20 address.
