...
description: >-
  ...
  the USC Blockchain Studio. The guide is aimed at teaching you how to create a new
  community after setting up Metamask or Torus and is
---

# Community creation tutorial

Make sure you are connected to the USC Blockchain network on your Metamask wallet before creating the community. Learn how to add USC Blockchain network to Metamask using [this](https://doc.poolscan.io/the-USC-studio/getting-started/how-to-add-USC-to-your-metamask) tutorial.
...
You can also view both your ETH balance and USC balance by clicking on “USC Blockchain network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on USC Blockchain”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to USC Blockchain network.
...
It's been a long road, but you are finally on the last step! To be able to make easy mobile transactions using your community, **download the USC Blockchain wallet app** on the [App Store](https://apps.apple.com/il/app/USC-wallet/id1491783654) or [Google Play](https://play.google.com/store/apps/details?id=io.USC.USCcash).
